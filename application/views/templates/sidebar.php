...
<div class="app-header header-shadow bg-premium-dark header-text-light"> <!--header color change-->
   <div class="app-header__logo">
      <div class="logo-src" style="color:#ffffff;font-size:20px;">MCUDP</div>
      ...
      <div class="app-header-right">
         <div class="header-dots">
            <div class="dropdown">
               ...
               <i class="dot-btn-icon lnr-cog icon-gradient bg-happy-itmeo">
               </i>
               </a>
            ...
            <div class="dropdown">
               <a class="dot-btn-wrapper" aria-haspopup="true" data-toggle="dropdown" aria-expanded="false">
               <i class="dot-btn-icon lnr-alarm icon-gradient bg-happy-itmeo">
               </i>
               </a>
               <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-xl rm-pointers dropdown-menu dropdown-menu-right">
            ...
            <div class="dropdown">
               <a class="dot-btn-wrapper" aria-haspopup="true" data-toggle="dropdown" aria-expanded="false">
               <i class="dot-btn-icon lnr-flag icon-gradient bg-happy-itmeo">
               </i>
               </a>
               ...
               <div class="widget-content-wrapper">
                  <div class="widget-content-left">
                     <div class="btn-group">
                        ...
                        <img width="42" class="rounded-circle" src="<?php echo base_url();?>assets/images/avatars/1.png" alt="">
                                       ...
                                       <div class="widget-content-wrapper">
                                          <div class="widget-content-left mr-3">
                                             <img width="42" class="rounded-circle"
                                                src="<?php echo base_url();?>assets/images/avatars/1.png"
                                                alt="">
                                          </div>
                                          <div class="widget-content-left">
...
<div class="app-main">
<div class="app-sidebar sidebar-shadow bg-premium-dark sidebar-text-light"><!--sidebar color change-->
   <div class="app-header__logo">
      ...
      <div class="app-sidebar__inner">
         <ul class="vertical-nav-menu">
            ...
            <li>
               ...
               <ul>
                  <li>
                     <a href="<?php base_url();?>procurement_plan">
            ...
            <li class="mm-active">
               ...
               <ul
                  >
                  <li>
                     <a href="<?php base_url();?>create_work">
                     <i class="metismenu-icon"></i>
                     Setup Work Package
                     </a>
                  </li>
                  <li>
                     <a href="<?php base_url();?>create_procurement_time_schedule">
                     <i class="metismenu-icon">
                     </i>Setup Procurement Timeline
                     </a>
                  </li>
                  <li>
                     <a href="<?php base_url();?>setup">
                     <i class="metismenu-icon">
                     </i>Setup
                     </a>
                  </li>
                  <li>
                     <a href="<?php base_url();?>create_supplementary_document">
                     <i class="metismenu-icon">
                     </i>Setup supplementary
                     </a>
                  </li>
                  <li>
                     <a href="<?php base_url();?>create_authority_limits">
                     <i class="metismenu-icon">
                     </i>Setup Authority Limits
                     </a>
                  </li>
                  <li>
                     <a href="<?php base_url();?>create_tender">
                     <i class="metismenu-icon">
                     </i>Setup Tender
                     </a>
                  </li>
            ...
            <li>
               ...
               <ul>
                  <li>
                     <a href="<?php base_url();?>reference_pattern">
                     <i class="metismenu-icon"></i>
                     Setup Reference Pattern  
                     </a>
                  </li>
                  <li>
                     <a href="<?php base_url();?>reference_pattern_prefix">
                     <i class="metismenu-icon">
                     </i>Setup Reference Fields
                     </a>
                  </li>
                  <li>
                     <a href="<?php base_url();?>reference_pattern_dynamic">
                     <i class="metismenu-icon">
                     </i>Adjust Reference Pattern 
                     </a>
                  </li>
               </ul>
            </li>
