...
<form class="needs-validation" enctype="multipart/form-data" id="" method="post" action="<?php echo base_url();?>Bid_opening_committee_register/create" >
 <div class="main-card mb-3 card">
  <div class="card-body">
    <h5 class="card-title"><i class="header-icon lnr-apartment icon-gradient bg-grow-early"></i>Bid Openning Committee Details</h5>
    <div class="form-row">
